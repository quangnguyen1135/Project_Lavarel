                    ...
                    <div class="grid">
                        <div class="grid__item large--one-third push--large--one-third text-center">
                            ...
                            <div id="CustomerLoginForm" class="form-vertical">
                                ...
                                <form accept-charset='UTF-8' method="post" action="{{ route('authenticate') }}" id='customer_login'>
                                    @csrf
                                    ...
                                    <p><a href="/">Trở về</a></p>
                                    <p><a href="register" id="customer_register_link">Đăng kí</a></p>
                                    <p><a href="#recover" id="RecoverPassword">Quên mật khẩu?</a></p>
                                    <input id='12f4107d9d2f45e4a974d0c6267c5aeb' name='g-recaptcha-response' type='hidden'>
                                </form>
                            ...
                            <div id="RecoverPasswordForm" style="display: none;">
                                ...
                                <div class="form-vertical">
                                    <!-- <form accept-charset='UTF-8' action='https://nhahangphuongnam.vn/account/recover' method='post'>
                                        ...
                                        <button type="button" id="HideRecoverPasswordLink" class="text-link">Bỏ
                                            qua</button>
                                        <input id='10e754eddfb54c65bf4129fb0afdb335' name='g-recaptcha-response' type='hidden'>
                                        ...
                                        <script>
                                            grecaptcha.ready(function() {
                                                grecaptcha.execute('6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-', {
                                                    ...
                                                    document.getElementById('10e754eddfb54c65bf4129fb0afdb335').value = token;
                                                });
                                            });
                                        </script>
                                    </form> -->
