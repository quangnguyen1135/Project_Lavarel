...
<div id="NavDrawer" class="drawer drawer--right">
    ...
    <ul class="mobile-nav">
        ...
        <li class="mobile-nav__item">
            <a href="/productsPage/" class="mobile-nav__link">Menu</a>
        </li>
        <li class="mobile-nav__item">
